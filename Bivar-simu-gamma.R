...
rho <- 0.4#corr=0.4/2=0.2 for G=0
...
write_xlsx(perf.allcase,"perf-allcase-gamma2.xlsx") 

write_xlsx(perf.allcase1,"perf-1-h-gamma2.xlsx") 
write_xlsx(perf.allcase2,"perf-2-h-gamma2.xlsx") 
